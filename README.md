...
- Core: open source under Apache-2.0 for teams to download, inspect, run, modify, and deploy. Core includes self-managed SSO/OIDC, audit logging, SIEM/security-monitoring export, and the included Steel Mission starter company.
...
The launch set contains no external company corpus. Owners and admins can revise it or add their own source-owned files, folders, repositories, users, missions, and profiles.
...
The application image includes the Steel Mission starter company, PRJ-0001
...
- The repository's Milestones and Issues are the working surface for PRJ-0001.

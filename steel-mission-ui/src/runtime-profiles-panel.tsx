    ...
    <div id="runtimeProfilesPanel" class="parity-panel">
      ...
      <div class="panel-form">
        <div class="panel-grid">
          ...
          <label>Model Binding<select value={String(profile.modelProvider || "auto")} onChange={(event) => update("modelProvider", event.currentTarget.value)}><option value="auto">auto</option><option value="claude">claude</option><option value="glimmer">glimmer</option></select></label>

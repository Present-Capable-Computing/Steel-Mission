...
const testEntries = ["assignments.test.ts", "audit.test.ts", "capabilities.test.ts", "control-plane.test.ts", "knowledge.test.ts", "missions.test.ts", "model-roles.test.ts", "organizations.test.ts", "runtime-profiles.test.ts", "settings.test.ts", "users.test.ts", "work-mode.test.ts"];
